					 ...
					 <li><a class="active-icon c1" href="#"> </a>
						<ul class="sub-icon1 list">
						  ...
						  <div class="login_buttons">
							 <div class="check_button"><a href="showCart">去购物车结算</a></div>
		...
		<div class="container">
			<div class="col-md-6">
				 <div class="login-page">
					...
					<div class="button1">
					   <a href="register.html"><input type="submit" name="Submit" value="创建一个帐户"></a>
					 </div>
					 <div class="clear"></div>
				  </div>
				</div>
				...
				<div class="col-md-6">
				 <div class="login-title">
					...
					<div id="loginbox" class="loginbox">
						<form action="UserLoginServlet" method="post" name="login" id="login-form">
						  <fieldset class="input">
						    <p id="login-form-username">
						      <label for="modlgn_username">邮箱</label>
						      <input id="modlgn_username" type="text" name="email" class="inputbox" size="18" autocomplete="off">
						      <span id="msg1">请输入邮箱名</span>
						    </p>
